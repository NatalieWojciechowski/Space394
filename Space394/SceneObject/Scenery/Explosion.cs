...
{
    public class Explosion : SceneObject
    {
        private ExplosionParticleGenerator generator;

        private Model explosion;

        private const float MAX_SCALE_RESCALE = 150f;
        private float MAX_SCALE = 100f; //150f; //50f;

        private const float SCALE_RATE_RESCALE = 75f;
        private float SCALE_RATE = 150f; //70;
        
        private const float OUTER_EXTRA_SIZE = 10f;

        private const float spinRate = 10.0f;
        private const float outerspinRate = 15.0f;
